    ...
    return (
        <div className='header'>
            ...
            <div className="header__right">
                ...
                <HeaderOptions avatar="True" title={user.displayName} onClick={logoutOf}/>
            </div>
        </div>
    )
}
